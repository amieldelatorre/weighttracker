...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
        ...
        internal static object[] WeightControllerGetWeightsTestProvider = [
            ...
            new object[]
            {
                ...
                3,       // Expected Limit
                0,       // Expected Offset
                "/Weight?limit=3&offset=3&datefrom=29/11/2023&dateto=7/12/2023"     // Expected Next value
            },
            new object[]
            {
                /*
                ...
                3,       // Expected Limit
                0,       // Expected Offset
                "/Weight?limit=3&offset=3&datefrom=29/11/2023"     // Expected Next value
            },
            new object[]
            {
                /*
                ...
                3,       // Expected Limit
                0,       // Expected Offset
                "/Weight?limit=3&offset=3&dateto=7/12/2023"     // Expected Next value
            },
        ];
